package butterfly.music.dialog;
...
public class ScannerDialog extends BottomDialog {
    ...
    private static final int MIN_DURATION = 30_000;
    ...
    private static class MusicDecoder extends MediaStoreHelper.Decoder<Music> {
        ...
        public Music decode(Cursor cursor) {
            return new Music(0,
                    getFileName(cursor),
                    optimizeText(getAudioArtist(cursor), R.string.snow_music_item_unknown_artist),
                    optimizeText(getAudioAlbum(cursor), R.string.snow_music_item_unknown_album),
